...
const ButtonRipple = React.forwardRef(({ onMouseDown,children,style, color = 'rgba(255,255,255,.5)', className, onClick,opacity }: Props,ref:any): ReactElement=> {
    ...
    return (
        <button onClick={onClick} ref={handleRef} style={style} onMouseUp={handleMouseUp} onMouseDown={handleMouseDown} className={clsx('btn-ripple', className)}>
            {children}
        </button>
    )
})
